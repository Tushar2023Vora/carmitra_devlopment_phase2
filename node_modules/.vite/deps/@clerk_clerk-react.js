...
// node_modules/@clerk/clerk-react/dist/chunk-BFSRD4AJ.mjs
...
var useAuth = () => {
  ...
  const has3 = (0, import_react10.useCallback)(
    (params) => {
...
var Portal = class extends import_react22.default.PureComponent {
  ...
  render() {
    var _a, _b, _c, _d;
    return import_react22.default.createElement(import_react22.default.Fragment, null, import_react22.default.createElement("div", { ref: this.portalRef }), isMountProps(this.props) && ((_b = (_a = this.props) == null ? void 0 : _a.customPagesPortals) == null ? void 0 : _b.map((portal, index) => (0, import_react22.createElement)(portal, { key: index }))), isMountProps(this.props) && ((_d = (_c = this.props) == null ? void 0 : _c.customMenuItemsPortals) == null ? void 0 : _d.map((portal, index) => (0, import_react22.createElement)(portal, { key: index }))));
  }
};
