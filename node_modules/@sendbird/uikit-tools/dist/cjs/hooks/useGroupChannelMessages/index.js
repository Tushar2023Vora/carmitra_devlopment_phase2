...
const chat_1 = require("@sendbird/chat");
const groupChannel_1 = require("@sendbird/chat/groupChannel");
const sbuConstants_js_1 = require("../../constants/sbuConstants.js");
const channel_js_1 = require("../../utils/channel.js");
const message_js_1 = require("../../utils/message.js");
const validators_js_1 = require("../../utils/validators.js");
const useForceUpdate_js_1 = require("../useForceUpdate.js");
...
const createMessageCollection = (channel, limit, options) => {
    ...
    return channel.createMessageCollection(Object.assign(Object.assign({}, basicParams), { filter: new groupChannel_1.MessageFilter(basicParams) }));
};
...
function getCollectionLimitBy(startingPoint) {
    return startingPoint < Date.now()
        ? sbuConstants_js_1.sbuConstants.collection.message.searchLimit
        : sbuConstants_js_1.sbuConstants.collection.message.defaultLimit;
}
/**
...
const useGroupChannelMessages = (sdk, channel, options = {}) => {
    var _a, _b, _c, _d;
    const internalOptions = (0, react_1.useRef)(options); // to keep reference of options in event handler
    internalOptions.current = options;
    const channelRef = (0, react_1.useRef)(channel); // to keep reference of channel in event handler
    ...
    const strictStreamingOrder = (_b = internalOptions.current.strictStreamingOrder) !== null && _b !== void 0 ? _b : false;
    const isFetching = (0, react_1.useRef)({ prev: false, next: false });
    const forceUpdate = (0, useForceUpdate_js_1.useForceUpdate)();
    const collectionRef = (0, react_1.useRef)({
        initialized: false,
        apiInitialized: false,
        instance: null,
    });
    const { initialized, loading, refreshing, messages, newMessages, updateMessages, updateNewMessages, deleteNewMessages, deleteMessages, updateInitialized, updateLoading, updateRefreshing, } = (0, reducer_js_1.useChannelMessagesReducer)(options === null || options === void 0 ? void 0 : options.sortComparator);
    const markAsReadBySource = (0, usePreservedCallback_js_1.usePreservedCallback)((source) => {
        var _a, _b, _c, _d;
        ...
        try {
            switch (source) {
                case chat_1.CollectionEventSource.EVENT_MESSAGE_RECEIVED:
                case chat_1.CollectionEventSource.EVENT_MESSAGE_SENT_SUCCESS:
                case chat_1.CollectionEventSource.SYNC_MESSAGE_FILL:
                case undefined:
    ...
    const updateNewMessagesReceived = (0, usePreservedCallback_js_1.usePreservedCallback)((source, messages) => {
        var _a, _b, _c, _d, _e;
        const incomingMessages = messages.filter((it) => { var _a; return !(0, message_js_1.isMyMessage)(it, (_a = sdk.currentUser) === null || _a === void 0 ? void 0 : _a.userId); });
    ...
    const init = (0, usePreservedCallback_js_1.usePreservedCallback)((channel, startingPoint, limit) => __awaiter(void 0, void 0, void 0, function* () {
        return new Promise((resolve, reject) => {
            ...
            const updateUnsentMessages = () => {
                ...
                if ((0, validators_js_1.isNotEmptyArray)(pendingMessages))
                    updateMessages(pendingMessages, false, (_b = sdk.currentUser) === null || _b === void 0 ? void 0 : _b.userId);
                if ((0, validators_js_1.isNotEmptyArray)(failedMessages))
                    updateMessages(failedMessages, false, (_c = sdk.currentUser) === null || _c === void 0 ? void 0 : _c.userId);
            };
            const collectionInstance = createMessageCollection(channel, limit, Object.assign(Object.assign({}, internalOptions.current), { startingPoint }));
            ...
            collectionInstance.setMessageCollectionHandler({
                onMessagesAdded: (ctx, __, messages) => {
                    ...
                    updateMessages(messages, false, (_a = sdk.currentUser) === null || _a === void 0 ? void 0 : _a.userId, strictStreamingOrder);
                },
                onMessagesUpdated: (ctx, __, messages) => {
                    ...
                    updateMessages(messages, false, (_a = sdk.currentUser) === null || _a === void 0 ? void 0 : _a.userId, strictStreamingOrder);
                    if (ctx.source === chat_1.CollectionEventSource.EVENT_MESSAGE_UPDATED) {
                ...
                onMessagesDeleted: (_, __, ___, messages) => {
                    ...
                    const reqIds = messages.filter(message_js_1.isSendableMessage).map((it) => it.reqId);
                ...
                onChannelUpdated: (ctx, channel) => {
                    var _a, _b;
                    forceUpdate();
                    (_b = (_a = internalOptions.current).onChannelUpdated) === null || _b === void 0 ? void 0 : _b.call(_a, channel, ctx);
                },
                onHugeGapDetected: () => {
                    init(channel, Number.MAX_SAFE_INTEGER, sbuConstants_js_1.sbuConstants.collection.message.defaultLimit);
                },
            });
            let hasCacheResultFailed = false;
            collectionInstance
                .initialize(groupChannel_1.MessageCollectionInitPolicy.CACHE_AND_REPLACE_BY_API)
                ...
                if (err) {
                    ...
                    hasCacheResultFailed ? reject(err) : resolve();
                }
                else if (messages) {
    ...
    (0, useGroupChannelHandler_js_1.useGroupChannelHandler)(sdk, {
        onUserBanned(eventChannel, bannedUser) {
            var _a, _b, _c;
            if (eventChannel.isGroupChannel() && !(0, channel_js_1.isDifferentChannel)(eventChannel, channelRef.current)) {
    ...
    (0, react_1.useLayoutEffect)(() => {
        const timeout = setTimeout(() => __awaiter(void 0, void 0, void 0, function* () {
            if (sdk.currentUser && channelRef.current) {
                ...
                updateLoading(true);
                yield init(channelRef.current, initialStartingPoint, initialLimit);
                updateLoading(false);
                updateInitialized(true);
            }
        }));
        return () => clearTimeout(timeout);
    }, [sdk, (_c = sdk.currentUser) === null || _c === void 0 ? void 0 : _c.userId, (_d = channelRef.current) === null || _d === void 0 ? void 0 : _d.url, internalOptions.current.replyType]);
    (0, react_1.useEffect)(() => {
        return () => {
            if (collectionRef.current.instance)
                collectionRef.current.instance.dispose();
    ...
    const refresh = (0, usePreservedCallback_js_1.usePreservedCallback)(() => __awaiter(void 0, void 0, void 0, function* () {
        if (sdk.currentUser && channelRef.current) {
            ...
            yield init(channelRef.current, Number.MAX_SAFE_INTEGER, sbuConstants_js_1.sbuConstants.collection.message.defaultLimit);
            updateRefreshing(false);
        }
    }));
    const loadPrevious = (0, usePreservedCallback_js_1.usePreservedCallback)(() => __awaiter(void 0, void 0, void 0, function* () {
        var _e;
        ...
        if ((collection === null || collection === void 0 ? void 0 : collection.hasPrevious) && !isFetching.current.prev) {
            try {
                ...
                updateMessages(list, false, (_e = sdk.currentUser) === null || _e === void 0 ? void 0 : _e.userId);
            }
            catch (_f) {
                // noop
            }
    ...
    const hasPrevious = (0, usePreservedCallback_js_1.usePreservedCallback)(() => {
    ...
    const loadNext = (0, usePreservedCallback_js_1.usePreservedCallback)(() => __awaiter(void 0, void 0, void 0, function* () {
        var _g;
        const collection = collectionRef.current.instance;
        if ((collection === null || collection === void 0 ? void 0 : collection.hasNext) && !isFetching.current.next) {
            try {
                ...
                updateMessages(list, false, (_g = sdk.currentUser) === null || _g === void 0 ? void 0 : _g.userId);
            }
            catch (_h) {
                // noop
            }
    ...
    const hasNext = (0, usePreservedCallback_js_1.usePreservedCallback)(() => {
    ...
    const sendUserMessage = (0, usePreservedCallback_js_1.usePreservedCallback)((params, onPending) => {
        var _a;
        if (!channelRef.current || !channelRef.current.url) {
    ...
    const sendFileMessage = (0, usePreservedCallback_js_1.usePreservedCallback)((params, onPending) => {
        var _a;
        if (!channelRef.current || !channelRef.current.url) {
            (_a = logger === null || logger === void 0 ? void 0 : logger.error) === null || _a === void 0 ? void 0 : _a.call(logger, '[useGroupChannelMessages] channel is required');
            throw new Error('Channel is required');
    ...
    const sendFileMessages = (0, usePreservedCallback_js_1.usePreservedCallback)((paramsList, onPending) => __awaiter(void 0, void 0, void 0, function* () {
        var _j;
        if (!channelRef.current || !channelRef.current.url) {
    ...
    const sendMultipleFilesMessage = (0, usePreservedCallback_js_1.usePreservedCallback)((params, onPending) => {
        var _a;
        if (!channelRef.current || !channelRef.current.url) {
            (_a = logger === null || logger === void 0 ? void 0 : logger.error) === null || _a === void 0 ? void 0 : _a.call(logger, '[useGroupChannelMessages] channel is required');
            throw new Error('Channel is required');
    ...
    const updateUserMessage = (0, usePreservedCallback_js_1.usePreservedCallback)((messageId, params) => __awaiter(void 0, void 0, void 0, function* () {
        var _k, _l;
        if (!channelRef.current || !channelRef.current.url) {
            (_k = logger === null || logger === void 0 ? void 0 : logger.error) === null || _k === void 0 ? void 0 : _k.call(logger, '[useGroupChannelMessages] channel is required');
            throw new Error('Channel is required');
        }
        ...
        if (updatedMessage.channelUrl === channelRef.current.url) {
            updateMessages([updatedMessage], false, (_l = sdk.currentUser) === null || _l === void 0 ? void 0 : _l.userId);
        }
        return updatedMessage;
    }));
    const updateFileMessage = (0, usePreservedCallback_js_1.usePreservedCallback)((messageId, params) => __awaiter(void 0, void 0, void 0, function* () {
        var _m, _o;
        if (!channelRef.current || !channelRef.current.url) {
            (_m = logger === null || logger === void 0 ? void 0 : logger.error) === null || _m === void 0 ? void 0 : _m.call(logger, '[useGroupChannelMessages] channel is required');
            throw new Error('Channel is required');
        }
        const updatedMessage = yield channelRef.current.updateFileMessage(messageId, params);
        if (updatedMessage.channelUrl === channelRef.current.url) {
            updateMessages([updatedMessage], false, (_o = sdk.currentUser) === null || _o === void 0 ? void 0 : _o.userId);
        }
        return updatedMessage;
    }));
    const resendMessage = (0, usePreservedCallback_js_1.usePreservedCallback)((failedMessage) => __awaiter(void 0, void 0, void 0, function* () {
        var _p;
        if (!channelRef.current || !channelRef.current.url) {
    ...
    const deleteMessage = (0, usePreservedCallback_js_1.usePreservedCallback)((message) => __awaiter(void 0, void 0, void 0, function* () {
        var _q, _r;
        if (!channelRef.current || !channelRef.current.url) {
            (_q = logger === null || logger === void 0 ? void 0 : logger.error) === null || _q === void 0 ? void 0 : _q.call(logger, '[useGroupChannelMessages] channel is required');
            throw new Error('Channel is required');
        }
        if (message.sendingStatus === 'succeeded') {
            ...
            try {
                yield ((_r = collectionRef.current.instance) === null || _r === void 0 ? void 0 : _r.removeFailedMessage(message.reqId));
            }
            finally {
    ...
    const resetNewMessages = (0, usePreservedCallback_js_1.usePreservedCallback)(() => {
        var _a;
        updateNewMessages([], true, (_a = sdk.currentUser) === null || _a === void 0 ? void 0 : _a.userId);
    });
    const resetWithStartingPoint = (0, usePreservedCallback_js_1.usePreservedCallback)((startingPoint) => __awaiter(void 0, void 0, void 0, function* () {
        var _s;
        if (sdk.currentUser && channelRef.current) {
            const limit = getCollectionLimitBy(startingPoint);
            updateLoading(true);
            updateMessages([], true, (_s = sdk.currentUser) === null || _s === void 0 ? void 0 : _s.userId);
            yield init(channelRef.current, startingPoint, limit);
            updateLoading(false);
        }
    }));
    return {
