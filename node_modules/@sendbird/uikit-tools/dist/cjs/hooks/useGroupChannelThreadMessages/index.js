...
exports.useGroupChannelThreadMessages = void 0;
...
const useGroupChannelThreadMessages = (sdk, channel, parentMessage, options = {}) => {
    var _a, _b, _c, _d, _e;
    ...
    const parentMessageRef = (0, react_1.useRef)(parentMessage); // to keep reference of parent message in event handler
    parentMessageRef.current = parentMessage;
    const startingPoint = (0, react_1.useRef)(((_a = internalOptions.current) === null || _a === void 0 ? void 0 : _a.startingPoint) || Number.MAX_SAFE_INTEGER);
    startingPoint.current = ((_b = internalOptions.current) === null || _b === void 0 ? void 0 : _b.startingPoint) || Number.MAX_SAFE_INTEGER;
    const prevFetchSize = sbuConstants_js_1.sbuConstants.collection.message.defaultLimit.prev;
    const nextFetchSize = sbuConstants_js_1.sbuConstants.collection.message.defaultLimit.next;
    ...
    const { initialized, loading, refreshing, hasPreviousMessages, hasNextMessages, oldestMessageTimeStamp, latestMessageTimeStamp, messages, newMessages, updateMessages, updateNewMessages, deleteNewMessages, deleteMessages, updateInitialized, updateLoading, updateRefreshing, updateHasPreviousMessages, updateHasNextMessages, } = (0, reducer_js_1.useChannelThreadMessagesReducer)(options === null || options === void 0 ? void 0 : options.sortComparator);
    ...
    const updateNewMessagesReceived = (0, usePreservedCallback_js_1.usePreservedCallback)((source, messages) => {
        var _a, _b, _c, _d, _e;
        const incomingMessages = messages.filter((it) => { var _a; return isThreadedMessage(it, parentMessageRef.current) && !(0, message_js_1.isMyMessage)(it, (_a = sdk.currentUser) === null || _a === void 0 ? void 0 : _a.userId); });
    ...
    const init = (0, usePreservedCallback_js_1.usePreservedCallback)((startingPoint) => __awaiter(void 0, void 0, void 0, function* () {
        return new Promise((resolve) => {
            ...
            const updateUnsentMessages = () => {
                ...
                if ((0, validators_js_1.isNotEmptyArray)(filteredMessages))
            ...
            setTimeout(() => __awaiter(void 0, void 0, void 0, function* () {
                ...
                try {
                    if (parentMessageRef.current) {
                        ...
                        if ((0, validators_js_1.isNotEmptyArray)(threadedMessages)) {
            ...
            const collectionInstance = channelRef.current.createMessageCollection({
                ...
                filter: new groupChannel_1.MessageFilter({ replyType: message_1.ReplyType.ALL }),
            });
            ...
            collectionInstance.setMessageCollectionHandler({
                ...
                onMessagesDeleted: (_, __, ___, messages) => {
                    ...
                    if ((0, validators_js_1.isNotEmptyArray)(filteredMessages)) {
                        ...
                        const reqIds = filteredMessages.filter(message_js_1.isSendableMessage).map((it) => it.reqId);
...
exports.useGroupChannelThreadMessages = useGroupChannelThreadMessages;
