...
import type { GroupChannel, GroupChannelEventContext, GroupChannelModule } from '@sendbird/chat/groupChannel';
import type { BaseMessage, FileMessage, FileMessageCreateParams, FileMessageUpdateParams, MultipleFilesMessage, MultipleFilesMessageCreateParams, UserMessage, UserMessageCreateParams, UserMessageUpdateParams } from '@sendbird/chat/message';
...
type UseGroupChannelThreadMessagesOptions = {
    ...
    onParentMessageUpdated?: (messages: UserMessage | FileMessage) => void;
...
export declare const useGroupChannelThreadMessages: (sdk: SendbirdChatWith<[GroupChannelModule]>, channel: GroupChannel, parentMessage: FileMessage | UserMessage, options?: UseGroupChannelThreadMessagesOptions) => {
    /**
