...
import type { GroupChannel, GroupChannelEventContext, GroupChannelModule, MessageCollection, MessageCollectionParams, MessageFilterParams } from '@sendbird/chat/groupChannel';
...
export declare const useGroupChannelMessages: (sdk: SendbirdChatWith<[GroupChannelModule]>, channel: GroupChannel, options?: UseGroupChannelMessagesOptions) => {
     ...
     * Do not use this api
     * */
    _dangerous_reducer_updateMessages: (messages: BaseMessage[], clearBeforeAction: boolean, currentUserId?: string | undefined, strictStreamingOrder?: boolean | undefined) => void;
    /**
     * Do not use this api
     * */
