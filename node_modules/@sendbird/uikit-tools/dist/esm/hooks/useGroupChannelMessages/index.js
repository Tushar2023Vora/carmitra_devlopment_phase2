...
export const useGroupChannelMessages = (sdk, channel, options = {}) => {
    ...
    const init = usePreservedCallback((channel, startingPoint, limit) => __awaiter(void 0, void 0, void 0, function* () {
        return new Promise((resolve, reject) => {
            ...
            collectionInstance.setMessageCollectionHandler({
                ...
                onHugeGapDetected: () => {
                    init(channel, Number.MAX_SAFE_INTEGER, sbuConstants.collection.message.defaultLimit);
                },
            });
    ...
    const refresh = usePreservedCallback(() => __awaiter(void 0, void 0, void 0, function* () {
        if (sdk.currentUser && channelRef.current) {
            ...
            yield init(channelRef.current, Number.MAX_SAFE_INTEGER, sbuConstants.collection.message.defaultLimit);
