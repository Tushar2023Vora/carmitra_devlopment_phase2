...
function updateChannelConfig(
  ...
  if (remote.groupChannel?.channel && isBoolean(remote.groupChannel?.channel?.enableMarkAsUnread)) {
    target.channel.enableMarkAsUnread = remote.groupChannel.channel.enableMarkAsUnread;
  }
  if (local.groupChannel?.channel && isBoolean(local.groupChannel?.channel?.enableMarkAsUnread)) {
    target.channel.enableMarkAsUnread = local.groupChannel?.channel?.enableMarkAsUnread;
  }
