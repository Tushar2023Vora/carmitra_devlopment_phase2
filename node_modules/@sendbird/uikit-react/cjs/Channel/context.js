...
var UserProfileContext = require('../chunks/bundle-H44hyvFN.js');
var _const = require('../chunks/bundle-JR9-1BeM.js');
var utils = require('../chunks/bundle-C9bb3iWF.js');
var getIsReactionEnabled = require('../chunks/bundle-DFpSNLcN.js');
...
var Channel_hooks_useInitialMessagesFetch = require('../chunks/bundle-D-DJSLcL.js');
var compareIds = require('../chunks/bundle-HkyQ0DjT.js');
var index$1 = require('../chunks/bundle-BUPw_lsA.js');
var groupChannel = require('@sendbird/chat/groupChannel');
var uuid = require('../chunks/bundle-BeuUz2c0.js');
var useSendbird = require('../chunks/bundle-D6mmpicY.js');
var useReconnectOnIdle = require('../chunks/bundle-DB3ydfO3.js');
var consts = require('../chunks/bundle-DWBI0JnU.js');
var pubSub_topics = require('../chunks/bundle-CyJimqL9.js');
...
var ChannelProvider = function (props) {
    ...
    var uikitConfig = uikitTools.useUIKitConfig().configs;
    ...
    var _r = React.useReducer(channelReducer, _tslib.__assign(_tslib.__assign({}, initialState), { stringSet: stringSet })), messagesStore = _r[0], messagesDispatcher = _r[1];
    ...
    return (React__default.default.createElement(uikitTools.UIKitConfigProvider, { storage: uikitConfigStorage.uikitConfigStorage, localConfigs: _tslib.__assign(_tslib.__assign({}, uikitConfig), { groupChannel: _tslib.__assign(_tslib.__assign({}, uikitConfig.groupChannel), { channel: _tslib.__assign(_tslib.__assign({}, uikitConfig.groupChannel.channel), { enableMarkAsUnread: false }) }) }) },
        React__default.default.createElement(ChannelContext.Provider, { value: {
                // props
                channelUrl: channelUrl,
