...
var ui_ContextMenu = require('./bundle-BWLRRAFI.js');
var _tslib = require('./bundle-DdEJUQ3V.js');
var ui_IconButton = require('../ui/IconButton.js');
var ui_Icon = require('../ui/Icon.js');
var index = require('./bundle-BUPw_lsA.js');
...
var MarkAsUnreadMenuItem = function (props) {
    var _a;
    var stringSet = LocalizationContext.useLocalization().stringSet;
    var _b = ui_ContextMenu.useMessageMenuContext(), message = _b.message, hideMenu = _b.hideMenu, markAsUnread = _b.markAsUnread;
    return (React__default.default.createElement(ui_ContextMenu.MenuItem, _tslib.__assign({}, props, { onClick: function (e) {
            var _a;
            if (markAsUnread) {
...
var showMenuItemMarkAsUnread = function (_a) {
    ...
    return !index.isFailedMessage(message) && !index.isPendingMessage(message) && ((_b = channel === null || channel === void 0 ? void 0 : channel.isGroupChannel) === null || _b === void 0 ? void 0 : _b.call(channel)) && replyType !== 'THREAD';
};

var MessageMenu = function (_a) {
    var _b;
    var className = _a.className, message = _a.message, channel = _a.channel, isByMe = _a.isByMe, replyType = _a.replyType, _c = _a.renderTrigger, renderTrigger = _c === void 0 ? TriggerIcon : _c, renderMenuItems = _a.renderMenuItems, _d = _a.disableDeleteMessage, disableDeleteMessage = _d === void 0 ? null : _d, _e = _a.showEdit, showEdit = _e === void 0 ? utils.noop : _e, _f = _a.showRemove, showRemove = _f === void 0 ? utils.noop : _f, deleteMessage = _a.deleteMessage, resendMessage = _a.resendMessage, markAsUnread = _a.markAsUnread, setQuoteMessage = _a.setQuoteMessage, onReplyInThread = _a.onReplyInThread, onMoveToParentMessage = _a.onMoveToParentMessage;
    var _g = useSendbird.useSendbird().state.config, isOnline = _g.isOnline, enableMarkAsUnread = _g.groupChannel.enableMarkAsUnread;
    var triggerRef = React.useRef(null);
    var containerRef = React.useRef(null);
    var _h = React.useState(false), isMenuVisible = _h[0], setMenuVisibility = _h[1];
    ...
    return (React__default.default.createElement("div", { className: utils.classnames('sendbird-message-menu', className), ref: containerRef },
        React__default.default.createElement(ui_ContextMenu.MessageMenuProvider, { value: {
            ...
            isMenuVisible && (React__default.default.createElement(ui_ContextMenu.MenuItems, { id: ui_ContextMenu.getObservingId(message.messageId), parentRef: triggerRef, parentContainRef: containerRef, closeDropdown: hideMenu, openLeft: isByMe }, (_b = renderMenuItems === null || renderMenuItems === void 0 ? void 0 : renderMenuItems({
                ...
                enableMarkAsUnread && showMenuItemMarkAsUnread(params) && React__default.default.createElement(MarkAsUnreadMenuItem, null),
...
//# sourceMappingURL=bundle-v95Xmjt9.js.map
