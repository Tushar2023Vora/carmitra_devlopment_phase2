...
var _tslib = require('./bundle-DdEJUQ3V.js');
var React = require('react');
var message = require('@sendbird/chat/message');
var groupChannel = require('@sendbird/chat/groupChannel');
var uikitTools = require('@sendbird/uikit-tools');
var UserProfileContext = require('./bundle-H44hyvFN.js');
var index$1 = require('./bundle-u5TfAXpt.js');
var SendbirdContext = require('./bundle-HERYYUXZ.js');
var utils = require('./bundle-Dlhvq6qJ.js');
var useSendbird = require('./bundle-D6mmpicY.js');
var getIsReactionEnabled = require('./bundle-DFpSNLcN.js');
var resolvedReplyType = require('./bundle-kYn7Bizj.js');
var pubSub_topics = require('./bundle-CyJimqL9.js');
var _const = require('./bundle-JR9-1BeM.js');
var useDeepCompareEffect = require('./bundle-DwuvGkzI.js');
var utils$1 = require('./bundle-kfqOElgK.js');
var SendbirdChat = require('@sendbird/chat');
var index = require('./bundle-CEY5QNl7.js');
var consts = require('./bundle-DWBI0JnU.js');
...
var useGroupChannel = function () {
    ...
    var markAsReadAll = React.useCallback(function (channel) {
    ...
    var setCurrentChannel = React.useCallback(function (channel) {
        store.setState(function (state) { return (_tslib.__assign(_tslib.__assign({}, state), { currentChannel: channel, fetchChannelError: null, quoteMessage: null, animatedMessageId: null, nicknamesMap: channel ? new Map(channel.members.map(function (_a) {
    ...
    var setReadStateChanged = React.useCallback(function (readState) {
        store.setState(function (state) { return (_tslib.__assign(_tslib.__assign({}, state), { readState: readState })); });
    }, []);
    var setFirstUnreadMessageId = React.useCallback(function (messageId) {
        store.setState(function (state) { return (_tslib.__assign(_tslib.__assign({}, state), { firstUnreadMessageId: messageId })); });
    }, []);
    var actions = React.useMemo(function () {
        return _tslib.__assign({ setCurrentChannel: setCurrentChannel, handleChannelError: handleChannelError, markAsReadAll: markAsReadAll, markAsUnread: state.markAsUnread, setReadStateChanged: setReadStateChanged, setFirstUnreadMessageId: setFirstUnreadMessageId, setQuoteMessage: setQuoteMessage, scrollToBottom: scrollToBottom, scrollToMessage: scrollToMessage, toggleReaction: toggleReaction, setAnimatedMessageId: setAnimatedMessageId, setIsScrollBottomReached: setIsScrollBottomReached }, messageActions);
    }, [
        setCurrentChannel,
        handleChannelError,
        markAsReadAll,
...
var GroupChannelManager = function (props) {
    ...
    var markAsUnreadSourceRef = React.useRef(undefined);
    var markAsUnread = React.useCallback(function (message, source) {
        var _a, _b, _c, _d;
    ...
    var messageDataSource = uikitTools.useGroupChannelMessages(sdkStore.sdk, state.currentChannel, {
        ...
        onMessagesReceived: function (messages) {
            if (isScrollBottomReached
                ...
                setTimeout(function () { return _tslib.__awaiter(void 0, void 0, void 0, function () { return _tslib.__generator(this, function (_a) {
        ...
        onChannelUpdated: function (channel, ctx) {
            if (ctx.source === SendbirdChat.CollectionEventSource.EVENT_CHANNEL_UNREAD
                && ctx.userIds.includes(userId)) {
                actions.setReadStateChanged('unread');
            }
            if (ctx.source === SendbirdChat.CollectionEventSource.EVENT_CHANNEL_READ
                && ctx.userIds.includes(userId)) {
    ...
    uikitTools.useAsyncLayoutEffect(function () { return _tslib.__awaiter(void 0, void 0, void 0, function () {
        ...
        return _tslib.__generator(this, function (_a) {
            ...
            if ((pubSub === null || pubSub === void 0 ? void 0 : pubSub.subscribe) === undefined)
                return [2 /*return*/];
            subscriptions = [
                pubSub.subscribe(pubSub_topics.pubSubTopics.SEND_USER_MESSAGE, handleExternalMessage),
                pubSub.subscribe(pubSub_topics.pubSubTopics.SEND_FILE_MESSAGE, handleExternalMessage),
            ];
    ...
    useDeepCompareEffect.useDeepCompareEffect(function () {
        updateState(_tslib.__assign(_tslib.__assign(_tslib.__assign(_tslib.__assign(_tslib.__assign(_tslib.__assign({ 
            // Channel state
...
var GroupChannelProvider = function (props) {
    return (React__default.default.createElement(InternalGroupChannelProvider, _tslib.__assign({ key: props.channelUrl }, props),
...
//# sourceMappingURL=bundle-DowCzqdD.js.map
