...
var index = require('./bundle-CyQuENXQ.js');
var LocalizationContext = require('./bundle-REYf6P50.js');
var _const = require('./bundle-JR9-1BeM.js');
var utils$1 = require('./bundle-Dlhvq6qJ.js');
var Message_hooks_useDirtyGetMentions = require('../Message/hooks/useDirtyGetMentions.js');
var index$1 = require('./bundle-BUPw_lsA.js');
var ui_DateSeparator = require('../ui/DateSeparator.js');
var ui_Label = require('./bundle-D66YmzI6.js');
var ui_MessageInput = require('../ui/MessageInput.js');
var _const$1 = require('./bundle-Dc6k4jof.js');
...
var SuggestedMentionListView = require('./bundle-rpradL3a.js');
var utils = require('./bundle-kfqOElgK.js');
var useSendbird = require('./bundle-D6mmpicY.js');
var color = require('./bundle-qNUnRJ-F.js');
...
var NewMessageIndicator = function (_a) {
    var _b = _a.children, children = _b === void 0 ? undefined : _b, _c = _a.className, className = _c === void 0 ? '' : _c, onVisibilityChange = _a.onVisibilityChange, _d = _a.separatorColor, separatorColor = _d === void 0 ? color.Colors.PRIMARY : _d;
    var separatorRef = React.useRef(null);
    var handleVisibilityChange = React.useCallback(function (isVisible) {
    ...
    return (React__default.default.createElement("div", { ref: separatorRef, className: _tslib.__spreadArray(_tslib.__spreadArray([], (Array.isArray(className) ? className : [className]), true), [
            'sendbird-separator',
        ], false).join(' ') },
        ...
        React__default.default.createElement("div", { className: "sendbird-separator__text" }, children
            || (React__default.default.createElement(ui_Label.Label, { type: ui_Label.LabelTypography.CAPTION_2, color: ui_Label.LabelColors.PRIMARY }, "New Messages"))),
...
var MessageView = function (props) {
    ...
    return (React__default.default.createElement("div", { className: utils.classnames('sendbird-msg-hoc sendbird-msg--scroll-ref', isAnimated && 'sendbird-msg-hoc__animated'), "data-testid": "sendbird-message-view", style: children || renderMessage ? undefined : { marginBottom: '2px' }, "data-sb-message-id": message.messageId, "data-sb-created-at": message.createdAt, ref: messageScrollRef },
        ...
        hasNewMessageSeparator
            && (React__default.default.createElement(NewMessageIndicator, { onVisibilityChange: onNewMessageSeparatorVisibilityChange },
                React__default.default.createElement(ui_Label.Label, { type: ui_Label.LabelTypography.CAPTION_2, color: ui_Label.LabelColors.PRIMARY }, "New Messages"))),
        renderChildren()));
};

exports.MessageView = MessageView;
//# sourceMappingURL=bundle-DB678BVx.js.map
