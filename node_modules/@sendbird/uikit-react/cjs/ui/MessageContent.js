...
var index$2 = require('../chunks/bundle-CyQuENXQ.js');
var ui_MessageStatus = require('../chunks/bundle-Bv2i41gB.js');
var MessageMenu = require('../chunks/bundle-v95Xmjt9.js');
...
var useLongPress = require('../chunks/bundle-y6-ks46c.js');
...
var index = require('../chunks/bundle-CejczCsL.js');
...
var useElementObserver = require('../chunks/bundle-DYiDFr98.js');
var consts = require('../chunks/bundle-DWBI0JnU.js');
...
function MessageContent(props) {
    ...
    var 
    // Internal props
    className = props.className, userId = props.userId, channel = props.channel, message$1 = props.message, _o = props.disabled, disabled = _o === void 0 ? false : _o, _p = props.chainTop, chainTop = _p === void 0 ? false : _p, _q = props.chainBottom, chainBottom = _q === void 0 ? false : _q, _r = props.isReactionEnabled, isReactionEnabled = _r === void 0 ? false : _r, _s = props.disableQuoteMessage, disableQuoteMessage = _s === void 0 ? false : _s, replyType = props.replyType, threadReplySelectType = props.threadReplySelectType, nicknamesMap = props.nicknamesMap, emojiContainer = props.emojiContainer, scrollToMessage = props.scrollToMessage, showEdit = props.showEdit, showRemove = props.showRemove, showFileViewer = props.showFileViewer, resendMessage = props.resendMessage, deleteMessage = props.deleteMessage, toggleReaction = props.toggleReaction, setQuoteMessage = props.setQuoteMessage, markAsUnread = props.markAsUnread, onReplyInThread = props.onReplyInThread, onQuoteMessageClick = props.onQuoteMessageClick, onMessageHeightChange = props.onMessageHeightChange, onBeforeDownloadFileMessage = props.onBeforeDownloadFileMessage, filterEmojiCategoryIds = props.filterEmojiCategoryIds;
    // Public props for customization
    var _t = utils.deleteNullish(props), _u = _t.renderSenderProfile, renderSenderProfile = _u === void 0 ? function (props) { return React__default.default.createElement(index.MessageProfile, _tslib.__assign({}, props)); } : _u, _v = _t.renderMessageBody, renderMessageBody = _v === void 0 ? function (props) { return React__default.default.createElement(index.MessageBody, _tslib.__assign({}, props)); } : _v, _w = _t.renderMessageHeader, renderMessageHeader = _w === void 0 ? function (props) { return React__default.default.createElement(index.MessageHeader, _tslib.__assign({}, props)); } : _w, _x = _t.renderMessageMenu, renderMessageMenu = _x === void 0 ? function (props) { return React__default.default.createElement(MessageMenu.MessageMenu, _tslib.__assign({}, props)); } : _x, _y = _t.renderEmojiMenu, renderEmojiMenu = _y === void 0 ? function (props) { return React__default.default.createElement(ui_MessageItemReactionMenu.MessageEmojiMenu, _tslib.__assign({}, props)); } : _y, _z = _t.renderEmojiReactions, renderEmojiReactions = _z === void 0 ? function (props) { return React__default.default.createElement(ui_EmojiReactions, _tslib.__assign({}, props)); } : _z, _0 = _t.renderMobileMenuOnLongPress, renderMobileMenuOnLongPress = _0 === void 0 ? function (props) { return React__default.default.createElement(ui_MobileMenu.MobileMenu, _tslib.__assign({}, props)); } : _0;
    var _1 = LocalizationContext.useLocalization(), dateLocale = _1.dateLocale, stringSet = _1.stringSet;
    var _2 = useSendbird.useSendbird().state, config = _2.config, eventHandlers = _2.eventHandlers;
    ...
    // Feedback states
    var _5 = React.useState(false), showFeedbackOptionsMenu = _5[0], setShowFeedbackOptionsMenu = _5[1];
    var _6 = React.useState(false), showFeedbackModal = _6[0], setShowFeedbackModal = _6[1];
    var _7 = React.useState(''), feedbackFailedText = _7[0], setFeedbackFailedText = _7[1];
    ...
    // Thread replies
    var displayThreadReplies = (message$1 === null || message$1 === void 0 ? void 0 : message$1.threadInfo)
    ...
    var hasFeedback = (_d = message$1 === null || message$1 === void 0 ? void 0 : message$1.myFeedback) === null || _d === void 0 ? void 0 : _d.rating;
    /**
    ...
    return (React__default.default.createElement("div", { className: index$1.getClassName([
        ...
        React__default.default.createElement("div", _tslib.__assign({ className: utils.classnames('sendbird-message-content__middle'), "data-testid": "sendbird-message-content__middle" }, (isMobile ? _tslib.__assign({}, longPress) : {}), { ref: contentRef }),
            ...
            React__default.default.createElement("div", { className: utils.classnames('sendbird-message-content__middle__body-container') },
                ...
                (isReactionEnabledInChannel && ((_h = message$1 === null || message$1 === void 0 ? void 0 : message$1.reactions) === null || _h === void 0 ? void 0 : _h.length) > 0) && (React__default.default.createElement("div", { className: utils.classnames('sendbird-message-content-reactions', index$1.isMultipleFilesMessage(message$1) ? 'image-grid'
            ...
            isFeedbackEnabled && React__default.default.createElement("div", { className: "sendbird-message-content__middle__body-container__feedback-buttons-container", ref: feedbackButtonsRef },
                React__default.default.createElement(ui_FeedbackIconButton, { isSelected: ((_j = message$1 === null || message$1 === void 0 ? void 0 : message$1.myFeedback) === null || _j === void 0 ? void 0 : _j.rating) === message.FeedbackRating.GOOD, onClick: function () { return _tslib.__awaiter(_this, void 0, void 0, function () {
                        var error_1;
                        var _a, _b;
                ...
                React__default.default.createElement(ui_FeedbackIconButton, { isSelected: ((_k = message$1 === null || message$1 === void 0 ? void 0 : message$1.myFeedback) === null || _k === void 0 ? void 0 : _k.rating) === message.FeedbackRating.BAD, onClick: function () { return _tslib.__awaiter(_this, void 0, void 0, function () {
                        var error_2;
                        var _a, _b;
                        return _tslib.__generator(this, function (_c) {
                            switch (_c.label) {
        ...
        ((_l = message$1 === null || message$1 === void 0 ? void 0 : message$1.myFeedback) === null || _l === void 0 ? void 0 : _l.rating) && showFeedbackOptionsMenu && (React__default.default.createElement(ui_MobileFeedbackMenu, { hideMenu: function () {
        ...
        ((_m = message$1 === null || message$1 === void 0 ? void 0 : message$1.myFeedback) === null || _m === void 0 ? void 0 : _m.rating) && showFeedbackModal && (React__default.default.createElement(ui_MessageFeedbackModal, { selectedFeedback: message$1.myFeedback.rating, message: message$1, onUpdate: function (selectedFeedback, comment) { return _tslib.__awaiter(_this, void 0, void 0, function () {
