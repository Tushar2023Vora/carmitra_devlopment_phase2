import { _ as __assign, c as __spreadArray } from '../chunks/bundle-BcmcHhQv.js';
...
import { U as UserProfileProvider } from '../chunks/bundle-BTe57HMb.js';
import { T as ThreadReplySelectType } from '../chunks/bundle-DAJLIQZw.js';
import { m as mergeAndSortMessages, p as passUnsuccessfullMessages, s as scrollIntoLast, d as scrollToRenderedMessage, g as getAllEmojisMapFromEmojiContainer, e as getNicknamesMapFromMembers } from '../chunks/bundle-Dntu5Q1l.js';
import { g as getIsReactionEnabled } from '../chunks/bundle-lHyjMBHE.js';
import { g as getStringSet } from '../chunks/bundle-HJB6-gWU.js';
import { f as format } from '../chunks/bundle-BYph6xb0.js';
import { SendingStatus, ReplyType, MessageMetaArray } from '@sendbird/chat/message';
import { K, S } from '../chunks/bundle-BFv38Gwl.js';
import { R as RESET_MESSAGES, F as FETCH_INITIAL_MESSAGES_START, a as FETCH_INITIAL_MESSAGES_SUCCESS, b as FETCH_PREV_MESSAGES_SUCCESS, P as PREV_RESULT_SIZE, c as FETCH_NEXT_MESSAGES_SUCCESS, N as NEXT_RESULT_SIZE, d as FETCH_INITIAL_MESSAGES_FAILURE, e as FETCH_PREV_MESSAGES_FAILURE, f as FETCH_NEXT_MESSAGES_FAILURE, S as SEND_MESSAGE_START, g as SEND_MESSAGE_SUCCESS, h as SEND_MESSAGE_FAILURE, i as SET_CURRENT_CHANNEL, j as SET_CHANNEL_INVALID, O as ON_MESSAGE_RECEIVED, k as ON_MESSAGE_UPDATED, l as ON_MESSAGE_THREAD_INFO_UPDATED, m as RESEND_MESSAGE_START, M as MARK_AS_READ, n as ON_MESSAGE_DELETED, o as ON_MESSAGE_DELETED_BY_REQ_ID, p as SET_EMOJI_CONTAINER, q as ON_REACTION_UPDATED, r as MESSAGE_LIST_PARAMS_CHANGED, s as ON_FILE_INFO_UPLOADED, t as ON_TYPING_STATUS_UPDATED, u as MARK_AS_UNREAD, v as useInitialMessagesFetch, w as channelActions } from '../chunks/bundle-DXF932mD.js';
import { c as compareIds } from '../chunks/bundle-zxsEkHB5.js';
import { m as isSendableMessage, a2 as filterMessageListParams } from '../chunks/bundle-AOpqwRaJ.js';
import { GroupChannelHandler } from '@sendbird/chat/groupChannel';
import { u as uuidv4 } from '../chunks/bundle-BJ2mapxw.js';
import { u as useSendbird } from '../chunks/bundle-BmiTBgG1.js';
import { u as useReconnectOnIdle } from '../chunks/bundle-BtWZVL0Z.js';
import { f as SCROLL_BOTTOM_DELAY_FOR_FETCH, e as SCROLL_BOTTOM_DELAY_FOR_SEND, a as VOICE_MESSAGE_FILE_NAME, b as VOICE_MESSAGE_MIME_TYPE, i as META_ARRAY_VOICE_DURATION_KEY, j as META_ARRAY_MESSAGE_TYPE_KEY, k as META_ARRAY_MESSAGE_TYPE_VALUE__VOICE } from '../chunks/bundle-D0HLMr8A.js';
import { p as pubSubTopics, b as PublishingModuleType, P as PUBSUB_TOPICS, s as shouldPubSubPublishToChannel } from '../chunks/bundle-DVZRgyYI.js';
import { g as getCaseResolvedReplyType, a as getCaseResolvedThreadReplySelectType } from '../chunks/bundle-C9cE3NlS.js';
import { u as useSendMultipleFilesMessage } from '../chunks/bundle-QsOY54vw.js';
...
var ChannelProvider = function (props) {
    ...
    var uikitConfig = useUIKitConfig().configs;
    ...
    var _r = useReducer(channelReducer, __assign(__assign({}, initialState), { stringSet: stringSet })), messagesStore = _r[0], messagesDispatcher = _r[1];
    ...
    return (React__default.createElement(UIKitConfigProvider, { storage: uikitConfigStorage, localConfigs: __assign(__assign({}, uikitConfig), { groupChannel: __assign(__assign({}, uikitConfig.groupChannel), { channel: __assign(__assign({}, uikitConfig.groupChannel.channel), { enableMarkAsUnread: false }) }) }) },
        React__default.createElement(ChannelContext.Provider, { value: {
                // props
                channelUrl: channelUrl,
