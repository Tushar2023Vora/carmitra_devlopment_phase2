import { _ as __assign } from '../chunks/bundle-BcmcHhQv.js';
import React__default, { useState } from 'react';
import { n as isUserMessage, C as copyToClipboard, y as isFailedMessage, s as isSentMessage, x as isPendingMessage, d as isFileMessage, i as isVoiceMessage, T as isThreadMessage, V as getEmojiListAll } from '../chunks/bundle-AOpqwRaJ.js';
import { n as noop, c as classnames } from '../chunks/bundle-D9zEvquw.js';
import { u as useMessageMenuContext, a as MenuItem, M as MessageMenuProvider, b as MenuItems, B as BottomSheetMenuItem } from '../chunks/bundle-BDklsUYB.js';
import './IconButton.js';
import { u as useLocalization } from '../chunks/bundle-DEkOOCXV.js';
...
import './Button.js';
import '../chunks/bundle-CbGayeW1.js';
...
var MarkAsUnreadMenuItem$1 = function (props) {
    var _a;
    var stringSet = useLocalization().stringSet;
    ...
    return (React__default.createElement(MenuItem, __assign({}, props, { onClick: function (e) {
        ...
        React__default.createElement(Label, { type: LabelTypography.SUBTITLE_1, color: LabelColors.ONBACKGROUND_1 }, stringSet.MESSAGE_MENU__MARK_AS_UNREAD),
        React__default.createElement(Icon, { type: IconTypes.MARK_AS_UNREAD, fillColor: IconColors.PRIMARY, width: "24px", height: "24px" })))));
};

var MobileContextMenu = function (props) {
    var _a, _b, _c, _d, _e;
    var channel = props.channel, message = props.message, replyType = props.replyType, userId = props.userId, resendMessage = props.resendMessage, showEdit = props.showEdit, showRemove = props.showRemove, deleteMenuState = props.deleteMenuState, deleteMessage = props.deleteMessage, setQuoteMessage = props.setQuoteMessage, parentRef = props.parentRef, onReplyInThread = props.onReplyInThread, _f = props.isOpenedFromThread, isOpenedFromThread = _f === void 0 ? false : _f, _g = props.onDownloadClick, onDownloadClick = _g === void 0 ? null : _g, renderMenuItems = props.renderMenuItems, hideMobileMenu = props.hideMenu;
    ...
    var showMenuItemMarkAsUnread = !isFailedMessage(message) && !isPendingMessage(message) && message.parentMessageId <= 0 && ((_b = channel === null || channel === void 0 ? void 0 : channel.isGroupChannel) === null || _b === void 0 ? void 0 : _b.call(channel));
    var disableDeleteMessage = (deleteMenuState !== undefined && deleteMenuState === 'DISABLE') || ((_d = (_c = message === null || message === void 0 ? void 0 : message.threadInfo) === null || _c === void 0 ? void 0 : _c.replyCount) !== null && _d !== void 0 ? _d : 0) > 0;
    var contextValue = {
        message: message,
    ...
    return (React__default.createElement(MessageMenuProvider, { value: contextValue },
        React__default.createElement(MenuItems, { className: "sendbird-message__mobile-context-menu", parentRef: parentRef, parentContainRef: parentRef, closeDropdown: hideMobileMenu }, (_e = renderMenuItems === null || renderMenuItems === void 0 ? void 0 : renderMenuItems({
            items: {
                CopyMenuItem: CopyMenuItem$1,
                ReplyMenuItem: ReplyMenuItem$1,
                ThreadMenuItem: ThreadMenuItem$1,
                EditMenuItem: EditMenuItem$1,
                MarkAsUnreadMenuItem: MarkAsUnreadMenuItem$1,
                ResendMenuItem: ResendMenuItem$1,
                DeleteMenuItem: DeleteMenuItem$1,
            },
        })) !== null && _e !== void 0 ? _e : (React__default.createElement(React__default.Fragment, null,
            ...
            enableMarkAsUnread && showMenuItemMarkAsUnread && React__default.createElement(MarkAsUnreadMenuItem$1, null),
...
var MobileBottomSheet = function (props) {
    ...
    var showMenuItemThread = (replyType === 'THREAD') && !isOpenedFromThread
        ...
        && ((channel === null || channel === void 0 ? void 0 : channel.isGroupChannel()) && !(channel === null || channel === void 0 ? void 0 : channel.isBroadcast));
    var showMenuItemMarkAsUnread = !isFailedMessage(message)
        && !isPendingMessage(message)
        && ((_d = channel === null || channel === void 0 ? void 0 : channel.isGroupChannel) === null || _d === void 0 ? void 0 : _d.call(channel))
        && replyType !== 'THREAD';
    var maxEmojisPerRow = Math.floor(window.innerWidth / EMOJI_SIZE) - 1;
    var _j = useState(false), showEmojisOnly = _j[0], setShowEmojisOnly = _j[1];
    ...
    return (React__default.createElement(MessageMenuProvider, { value: contextValue },
        React__default.createElement(BottomSheet, { onBackdropClick: hideMenu },
            React__default.createElement("div", { className: "sendbird-message__bottomsheet" },
                ...
                !showEmojisOnly && (React__default.createElement("div", { className: "sendbird-message__bottomsheet--actions" }, (_e = renderMenuItems === null || renderMenuItems === void 0 ? void 0 : renderMenuItems({
                    items: {
                    ...
                    enableMarkAsUnread && showMenuItemMarkAsUnread && React__default.createElement(MarkAsUnreadMenuItem, null),
