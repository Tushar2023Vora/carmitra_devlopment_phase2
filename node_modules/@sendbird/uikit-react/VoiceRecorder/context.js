...
import { B as BROWSER_SUPPORT_MIME_TYPE_LIST, V as VOICE_RECORDER_AUDIO_BIT_RATE, a as VOICE_MESSAGE_FILE_NAME, b as VOICE_MESSAGE_MIME_TYPE } from '../chunks/bundle-D0HLMr8A.js';
...
var VoiceRecorderProvider = function (props) {
    ...
    useEffect(function () {
        if (isVoiceMessageEnabled && !webAudioUtils) {
            import('../chunks/bundle-CZELfPry.js').then(function (module) { return setWebAudioUtils(module); });
        }
