...
import { q as DEFAULT_UPLOAD_SIZE_LIMIT, D as DEFAULT_MULTIPLE_FILES_MESSAGE_LIMIT } from './bundle-D0HLMr8A.js';
...
function createStore(initialState) {
    ...
    var processQueue = function () {
        ...
        if (!job)
            return;
        var partial = job.partial, force = job.force;
    ...
    var setState = function (partial, force) {
        queue.push({ partial: partial, force: force });
        processQueue();
    };
    return {
...
//# sourceMappingURL=bundle-nSggTugx.js.map
